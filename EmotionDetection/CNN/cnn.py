...
def save_weights():
    ...
    json_model_file = open('model_4layer_2_2_pool.json', 'r')
    loaded_model_json = json_model_file.read()
    json_model_file.close()
    loaded_model = model_from_json(loaded_model_json)
    # load weights from h5 file
    loaded_model.load_weights("model_4layer_2_2_pool_weights.h5")
...
if not is_weights_saved:
    ...
    model.save_weights("model_4layer_2_2_pool_weights.h5")
